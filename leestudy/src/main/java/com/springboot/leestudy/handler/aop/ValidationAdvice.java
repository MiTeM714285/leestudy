package com.springboot.leestudy.handler.aop;
...
import com.springboot.leestudy.handler.ex.CustomValidationApiException;
...
public class ValidationAdvice {
	...
	@Around("execution(* com.springboot.leestudy.web.controller.api.*Controller.*(..))") // 모든 Controller를 포함한 클래스에 접근. *(..)는 매개변수를 0개 이상(..) 받는 모든 메소드(*)에 접근한다는 의미
